...
class ImportBot(BaseSample):
    ...
    def setup_field(self):
        ...
        field_1 = RigidPrim("/World/FE_2023","field_1_view",position=np.array([0.0,0.0,0.0]),scale=np.array([0.9, 0.9, 0.9]))
        ...
        chargestation_1 = GeometryPrim("/World/ChargeStation_1","cone_3_view",position=np.array([-4.00035,1.06439,0.025]),scale=np.array([0.04,0.04,0.04]), orientation=np.array([ 1,1,0,0 ]))
        chargestation_2 = GeometryPrim("/World/ChargeStation_2","cone_4_view",position=np.array([4.00035,1.06439,0.025]),scale=np.array([0.04,0.04,0.04]), orientation=np.array([ 1,1,0,0 ]))
