...
class ImportBot(BaseSample):
    ...
    def setup_field(self):
        ...
        field_1 = RigidPrim("/World/FE_2023","field_1_view",position=np.array([0.0,0.0,0.0]))
        ...
        chargestation_1 = GeometryPrim("/World/ChargeStation_1","cone_3_view",position=np.array([-4.20298,-0.56861,1.0]),scale=np.array([0.05,0.05,0.05]), orientation=np.array([ 1,0,0,0 ]))
        chargestation_2 = GeometryPrim("/World/ChargeStation_2","cone_4_view",position=np.array([4.20298,0.56861,1.0]),scale=np.array([0.04,0.04,0.04]), orientation=np.array([ 1,0,0,0 ]))
        ...
        self.cone_list.append( RigidPrim("/World/Cone_5","cone_5_view",position=np.array([-8.09697,-2.18889,1.03865])))
        self.cone_list.append( RigidPrim("/World/Cone_6","cone_6_view",position=np.array([8.08549,-2.14561,0.96511])))
        ...
        self.cube_list.append( RigidPrim("/World/Cube_5","cube_5_view",position=np.array([-8.09165,-3.31775,1.0706])))
        self.cube_list.append( RigidPrim("/World/Cube_6","cube_6_view",position=np.array([8.14898,-3.46793,1.07054])))
