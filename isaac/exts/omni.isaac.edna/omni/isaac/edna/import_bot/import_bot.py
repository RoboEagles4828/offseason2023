        ...
        og.Controller.edit(
            {"graph_path": robot_controller_path, "evaluator_name": "execution"},
            {
                og.Controller.Keys.CREATE_NODES: [
                    ...
                    ("articulation_controller_drive", "omni.isaac.core_nodes.IsaacArticulationController"),
                    ("articulation_controller_arm", "omni.isaac.core_nodes.IsaacArticulationController"),
                ],
                og.Controller.Keys.SET_VALUES: [
                    ("PublishJointState.inputs:topicName", "isaac_joint_states"),
                    ("SubscribeDriveState.inputs:topicName", "isaac_drive_commands"),
                    ("SubscribeArmState.inputs:topicName", "isaac_arm_commands"),
                    ("articulation_controller_drive.inputs:usePath", False),
                    ("articulation_controller_arm.inputs:usePath", False),
                ...
                og.Controller.Keys.CONNECT: [
                    ...
                    ("OnPlaybackTick.outputs:tick", "articulation_controller_drive.inputs:execIn"),
                    ("OnPlaybackTick.outputs:tick", "articulation_controller_arm.inputs:execIn"),
                    ...
                    ("SubscribeArmState.outputs:jointNames", "articulation_controller_arm.inputs:jointNames"),
                    ("SubscribeDriveState.outputs:jointNames", "articulation_controller_drive.inputs:jointNames"),
                    ("SubscribeDriveState.outputs:effortCommand", "articulation_controller_drive.inputs:effortCommand"),
                    ("SubscribeArmState.outputs:positionCommand", "articulation_controller_arm.inputs:positionCommand"),
                ],
            }
        )
