...
echo "if [ ! -d /workspaces/offseason2023/install ]; then" >> ~/.zshrc
echo "echo -e 'No install folder found remember to build with ctrl + shift + b\n';" >> ~/.zshrc
echo "else source /workspaces/offseason2023/install/setup.zsh; fi" >> ~/.zshrc
...
isaac rm &
isaac-ros rm &
rm -rf /workspaces/offseason2023/install /workspaces/offseason2023/build /workspaces/offseason2023/log